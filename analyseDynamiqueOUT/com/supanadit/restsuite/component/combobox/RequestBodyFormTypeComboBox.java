...
public class RequestBodyFormTypeComboBox extends JComboBox<BodyFormTypeModel> {
    ...
    public String toString() {
        analyse.Analyse.printAnalysis("BodyFormTypeModel","RequestBodyFormTypeComboBox");
        analyse.Analyse.printAnalysis("RequestBodyFormTypeComboBox","RequestBodyFormTypeComboBox");
