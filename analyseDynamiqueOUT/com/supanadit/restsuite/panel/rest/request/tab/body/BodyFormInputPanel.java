...
public class BodyFormInputPanel extends JPanel implements DocumentListener {
    ...
    public void checkType() {
        analyse.Analyse.printAnalysis("InputBodyValue","BodyFormInputPanel");
        analyse.Analyse.printAnalysis("InputBodyValue","BodyFormInputPanel");
        analyse.Analyse.printAnalysis("BodyFormTypeModel","BodyFormInputPanel");
        analyse.Analyse.printAnalysis("BodyFormTypeModel","BodyFormInputPanel");
        analyse.Analyse.printAnalysis("RequestBodyFormTypeComboBox","BodyFormInputPanel");
    ...
    public void remove() {
        analyse.Analyse.printAnalysis("BodyFormPanel","BodyFormInputPanel");
    ...
    public void removeFromStorage() {
        analyse.Analyse.printAnalysis("BodyFormInputPanel","BodyFormInputPanel");
        remove();
        if (id != 0) {
