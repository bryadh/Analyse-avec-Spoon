...
public class BodyFormPanel extends JScrollPane {
    ...
    public void addFormInput(BodyFormInputPanel bodyFormInputPanel) {
        analyse.Analyse.printAnalysis("BodyFormPanel","BodyFormPanel");
    ...
    public void addFormInput(CollectionBodyEntity collectionBodyEntity) {
        analyse.Analyse.printAnalysis("BodyFormPanel","BodyFormPanel");
        analyse.Analyse.printAnalysis("CollectionBodyEntity","BodyFormPanel");
        analyse.Analyse.printAnalysis("BodyFormInputPanel","BodyFormPanel");
        analyse.Analyse.printAnalysis("CollectionBodyEntity","BodyFormPanel");
        analyse.Analyse.printAnalysis("CollectionBodyEntity","BodyFormPanel");
        analyse.Analyse.printAnalysis("CollectionBodyEntity","BodyFormPanel");
        // Get Type
